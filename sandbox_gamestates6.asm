...
player_ch .rs 1   ; $12 player current health
player_oh .rs 1   ; player original health
...
; proximity detector for damage
  lda yd
  cmp prox  ; is the y-delta less than 60?
  bcs clear2 ; no, branch to clear
  lda xd    
  cmp prox  ; is the x-delta less than 90?
  bcs clear2 ; no, branch to clear
  lda #$1
  sta player_enemy_collision ; 
